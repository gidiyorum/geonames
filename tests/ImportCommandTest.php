...
use Gidiyorum\Geonames\Commands\ImportCommand;
...
class ImportCommandTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testCountryOptionCall()
    {
        ...
        // confirm that the name was changed
        $files = $command->getFiles();
        $this->assertTrue('IP' === $files['names']);
    }
    ...
    public function testExtractZipMethod()
    {
        ...
        $this->assertTrue('zipped.txt' == $return);
    ...
    {
        return m::mock('Gidiyorum\Geonames\RepositoryInterface');
    }
}
